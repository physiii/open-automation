...
sudo cp install/files/motion.conf /etc/motion/motion.conf
sudo cp install/files/thread1.conf /etc/motion/thread1.conf
sudo cp install/files/thread2.conf /etc/motion/thread2.conf
sudo cp install/files/default.motion /etc/default/motion
