...
const listenForAutomationChanges = () => (dispatch) => {
	...
	addAutomation = (automation) => (dispatch) => {
		...
		Api.addAutomation(automation).then((data) => {
	...
	saveAutomation = (automation, originalAutomation) => (dispatch) => {
		...
		Api.saveAutomation(automation).catch((error) => {
	...
	deleteAutomation = (automation) => (dispatch) => {
		...
		Api.deleteAutomation(automation.id).catch((error) => {
