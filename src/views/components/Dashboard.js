...
export const Dashboard = (props) => (
	<div>
		...
		<PrivateRoute path={`${props.match.path}/recordings/:cameraId`} render={(routeProps) => (
			<CameraRecordings {...routeProps} cameraId={routeProps.match.params.cameraId} parentPath={props.match.path} />
		)} />
	</div>
);
