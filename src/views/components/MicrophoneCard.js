...
import './MicrophoneCard.css';

export class MicrophoneCard extends React.Component {
	constructor (props) {
		super(props);
	...
	render () {
		...
		return (
			<ServiceCardBase
				name={this.settings.name || 'Microphone'}
...
export default connect(null, null, mergeProps)(MicrophoneCard);
