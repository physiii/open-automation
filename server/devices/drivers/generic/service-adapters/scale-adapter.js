...
class GenericScaleAdapter extends GenericServiceAdapter {
	_adaptState (state) {
...
GenericScaleAdapter.generic_type = 'scale';
GenericScaleAdapter.relay_type = 'scale';
GenericScaleAdapter.settings_definitions = new Map([...GenericServiceAdapter.settings_definitions])
	.set('schedule', {
		type: 'list-of',
		label: 'Schedule',
	...
	.set('reset_cycletime', {
		type: 'boolean',
		label: 'Reset Scale Cycle Time',
		validation: {is_required: false}
	});

module.exports = GenericScaleAdapter;
