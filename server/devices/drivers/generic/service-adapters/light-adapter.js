...
class GenericLightAdapter extends GenericServiceAdapter {
	_adaptState (state) {
	...
	_adaptSocketEmit (event, data, callback = () => { /* no-op */ }) {
		...
		adapted_data[data['property']] = data.value;
		delete adapted_data.property;
		delete adapted_data.value;
...
GenericLightAdapter.generic_type = 'light';
GenericLightAdapter.relay_type = 'light';
GenericLightAdapter.settings_definitions = new Map([...GenericServiceAdapter.settings_definitions])
	.set('schedule', {
		type: 'list-of',
		label: 'Schedule',
...
module.exports = GenericLightAdapter;
